...
if (!uye) return message.reply({ content:` • Örnek; !perm @aspect/ID`});
...
const collector = msg.createMessageComponentCollector({ filter, componentType: 'SELECT_MENU', max: 4, time: 20000 });
