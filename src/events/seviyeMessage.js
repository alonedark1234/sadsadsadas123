...
module.exports = async (message) => {
  ...
  if (message.author.bot) return;
	...
	const background = await loadImage("https://cdn.discordapp.com/attachments/954879340158533692/1095463735440719872/image.png");            
	...
	.setColor("#fff")
	.printText(`+${250*(data.messageLevel+1)} Bonus Para KAZANDIN! `, 340, 70,350)
	...
	image.save()
	let para = 250*(data.messageLevel+1)
